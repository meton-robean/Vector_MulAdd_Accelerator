...
organization := "edu.rose-hulman.ece"
...
// Specifies where to get the scala test classes
// By default, it will be in src/test/scala/ (without the following line)
scalaSource in Test := baseDirectory.value / "tests"

// Specifies where to get the scala main classes
// By default, it will be in src/main/scala/ (without the following line)
